...
To initiate the implicit flow, that is, to obtain an ID Token and optionally an Access Token directly from the authorization server, use the same request,
...
~~~json
{
  "access_token": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjUwM2NWVWpDTXdValBLZVBDVHpnZ0p2MUVUdVV5MzZRVUJVWWxRbVhwTGcifQ..W0SFZptzr0-gpgZmi9hZOR7jKEjnbhYJz8-i3sA284oIfyu-p9CRdFyymOYiQuHCG4P-Ou2WGwQZdy2RlsZcqhTwu1xB_LudYd7XcriRTXQyK50E8Yvmo50sSXH8jy7h4Hu6WVFk7ZoYrJQ8ywfccIEgK25vq92M3X_92RXszgFBaJbgz01N4xy_PjpZq36HJuHIlDOIqg5dWf7ZTYtZxH3KVNzvmTRdrAd6w-MDZHTV-XKvRxahAGr5NqP8ghNlIx5Ep11Y33ON6SVGUBRXfn_2yExoCmWXg2HVD8uatGUsjTu0kTRo_dvwZCsAE48Q67IiIZrAGFI_BDs0uyTf_g",
  "token_type": "Bearer",
  "expires_in": 3600,
  "scope": "openid offline_access",
  "refresh_token": "IJFLydLpLZ7-9spMSePkqgBSTnjBluJIJi6HESG84cE",
  "id_token": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjUwM2NWVWpDTXdValBLZVBDVHpnZ0p2MUVUdVV5MzZRVUJVWWxRbVhwTGcifQ..gka0tUssZ9zvQVXpwOvRw4aPMNrqdmJgd2Ag8a60cokmrn87HBIzOd-7CUkGsN5r41KIbrEIRzuR07sU5rcZbDEKcCdSMmaRPsoJL3ELMa-2rqaEdu2VBSATXca0TNRESHkij4lrq_Mjp3E8jN9zcS8y2YzkOhCsYU8sAcJ8lGKVA6fnaHEFonGInlQoXxd12ukuusziCNtfrQb72U-FUmXEB_kcKlMItl064ImApPVHBI145yF4eXgH7qYq3yVanEp8rdGoJJRXaqh0h2Izl63ZYW6WBvzTgOis3NxrGM-Wu7dCZDwyv93k3jpQrLMEtGKvmFolOaXWiuTOPckDAA"
}
~~~
...
Parameter          | Description                                                                                         | Type       |
-------------------+-----------------------------------------------------------------------------------------------------+------------|
grant_type         | Can be one of the following: *authorization_code*, *password*, *refresh_token*, or *client_credentials* (*client_credentials* is in Beta release). Determines the mechanism Okta will use to authorize the creation of the tokens. | String |
